...
from app.config.ApiConstants import S3_URL
...
class ArchiveService:
    ...
    def _format_location(archive_all_list, latitude, longitude):
        result = {"subway_name": None,"thumbnail":None, "exit_number": None, "location": None,
        ...
        for archive in archive_all_list:
            ...
            if result["distance"] > distance:
                result["thumbnail"] = S3_URL + archive.thumbnail if archive.thumbnail != None else None
